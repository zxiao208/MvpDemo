...
public class MyFlowLayout extends ViewGroup {
    private List<List<View>> views;  //存放所有子元素
    ...
    /**
     * 设计思路：计算布局中所有子元素的宽度和高度，累加得到整个布局最终显示的宽度和高度
     * widthMeasureSpec  父类控件的宽 和 模式
     * heightMeasureSpec 父类控件的高 和 模式
     */
    @Override
    ...
    //onMeasure终于把自己的大小测试出来了，里面要放子控件了
    @Override
